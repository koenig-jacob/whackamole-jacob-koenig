...
def draw_grid(screen):
    for i in range(0, max(WINDOW_WIDTH, WINDOW_HEIGHT), GRID_SIZE):
        pygame.draw.line(screen, (0, 0, 0), (i, 0), (i, WINDOW_HEIGHT))
        pygame.draw.line(screen, (0, 0, 0), (0, i), (WINDOW_WIDTH, i))
